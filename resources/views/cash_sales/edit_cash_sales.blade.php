...
@section('breadcrumb')
    <div class="col-md-6 col-sm-12">
        <h1>Edit Cash Sales</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Home</li>
                <li class="breadcrumb-item">Sales</li>
                <li class="breadcrumb-item">Cash Sales</li>
                <li class="breadcrumb-item active" aria-current="page">Edit Cash Sales</li>
            </ol>
        </nav>
    </div>
@endsection
...
<div class="row">
    <form action="{{ action('CashSalesController@update', $cashSale->cash_sales_id) }}" enctype="multipart/form-data" method="post">
        {{ csrf_field() }}
        {{ method_field('put') }}
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="body">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Date</label>
                                <input type="text" id="date" data-date-autoclose="true" class="form-control datepicker" name="cs_date" value="{{ $cashSale->cs_date }}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="customer_id" required>
                                    <option value="{{ $cashSale->customer_id }}" selected>{{ $cashSale->fname . ' ' . $cashSale->lname }}</option>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="posting_period">
                                    <option value="{{ $cashSale->posting_date }}">{{ $cashSale->posting_date }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Cheque #</label>
                                <input type="text" class="form-control" name="cheque_no" value="{{ $cashSale->cheque_no }}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Memo</label>
                                <input type="text" class="form-control" name="memo" value="{{ $cashSale->memo }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="location_id" id="location_id" onchange="checkLocationItems(this)" required>
                                    <option value="{{ $cashSale->location_id }}" selected>{{ $cashSale->loc_name }}</option>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="department_id" id="department_id" required>
                                    <option value="{{ $cashSale->department_id }}" selected>{{ $cashSale->dept_name}}</option>
                ...
                <div class="body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="item">
                            ...
                            <div class="deleteIDs" style="display: none"></div>
...
<script>
    ...
    $( document ).ready(function() {
        var cash_sales_id = '<?= $cashSale->cash_sales_id ?>';
        cashSaleItems(cash_sales_id);
        checkLocationItems();
    });

    function cashSaleItems(id) {
        $.ajax({
            url: "{{ action('CashSalesController@cashSaleItems') }}",
            method: 'GET',
            dataType: "json",
            data: {'cash_sales_id': id},
            success: function (data) {
                showItemsOnLoad(data);
            },
            error: function () {
            }
        })
    ...
    function checkLocationItems() {
        ...
        $.ajax({
            ...
            method: 'GET',
            dataType: "json",
            data: {'location_id': location_id, 'cash_sales_id' : cash_sales_id},
            success: function (data) {
                $('.activeSelect').empty();
