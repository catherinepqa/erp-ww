...
@section('title', 'Update Inventory Adjustment')

@section('breadcrumb')
    <div class="col-md-12 col-sm-12">
        <h1>Update Inventory Adjustment</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Home</li>
                <li class="breadcrumb-item">Inventory</li>
                <li class="breadcrumb-item">Inventory Adjustment</li>
                <li class="breadcrumb-item active" aria-current="page">Update Inventory Adjustment</li>
            </ol>
        </nav>
    </div>
@endsection
            ...
            <div class="card">
                ...
                <div class="body">
                    <form action="{{ route('inventory_adjustment_updateData') }}" method="post" id="updateDataForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="date" data-date-autoclose="true" class="form-control" value="{{ date('m-d-Y', strtotime($data_arr['adjustment_date'])) }}" name="adj_date">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input id="test" type="text" class="form-control" name="adj_account" value="{{ $data_arr['adjustment_account'] }}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Estimated Total Value</label>
                                    <input type="text" class="form-control number" name="est_total_val" value="{{ $data_arr['est_total_value'] }}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="posting_period">
                                        @foreach($months as $item)
                                            <option value="{{ $item }}" @if (date('Y-M',  strtotime($data_arr['posting_period'])) == $item) selected @endif>{{ $item }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label>Memo</label>
                                    <textarea rows="5" class="form-control" name="memo">{{ $data_arr['memo'] }}</textarea>
                                </div>
                            </div>
                        ...
                        <input type="hidden" value="{{ $data_arr['inventory_adjustment_id'] }}" name="system_id">
