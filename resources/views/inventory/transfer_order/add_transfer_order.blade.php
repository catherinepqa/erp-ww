...
@section('title', 'Add Transfer Orders')
...
@section('breadcrumb')
    <div class="col-md-6 col-sm-12">
        <h1>Add Transfer Orders</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Home</li>
                <li class="breadcrumb-item">Inventory</li>
                <li class="breadcrumb-item">Transfer Orders</li>
                <li class="breadcrumb-item active" aria-current="page">Add Transfer Orders</li>
            </ol>
        </nav>
    </div>
@endsection
...
@section('content')
<form method="post" action="{{ route('inventory.order_addDataProcess') }}">
    @csrf
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="date1" data-date-autoclose="true" class="form-control" value="{{ $today }}" name="ship_date">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control from_location" name="ship_carrier">
                                            ...
                                            @foreach($carrier as $item)
                                                <option value="{{ $item->shipping_carrier_id }}">{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Shipping Cost</label>
                                        <input type="text" class="form-control" name="ship_cost">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" id="date2" data-date-autoclose="true" class="form-control data_7" value="{{ $today }}">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Expected Receipt Date</label>
                            <div class="input-group mb-3">
                                <input type="text" id="date3" data-date-autoclose="true" class="form-control edit_data_7" value="{{ $today }}">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
...
@section('js')
    ...
    <script src="{{ URL::asset('assets/js/pages/transfer_order/add_transfer_order.js') }}"></script>
@endsection
