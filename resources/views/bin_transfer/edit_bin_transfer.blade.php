...
@section('breadcrumb')
    <div class="col-md-6 col-sm-12">
        <h1>New Bin Transfer Transaction</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Home</li>
                <li class="breadcrumb-item">Inventory</li>
                <li class="breadcrumb-item">Bin Transfer</li>
                <li class="breadcrumb-item active" aria-current="page">New Bin Transfer Transaction</li>
            </ol>
        </nav>
    </div>
@endsection
...
<div class="row">
    <form action="{{ action('BinTransferController@store') }}" enctype="multipart/form-data" method="post">
        {{ csrf_field() }}
        <div class="col-lg-12">
            <div class="card">
                <div class="actionBtn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="date" data-date-autoclose="true" class="form-control datepicker" name="transfer_date">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-hover js-basic-example dataTable table-custom spacing5">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <select class="form-control from_bin_id intDetailTo" name="from_bin_id"></select>
                                        </td>
                                        <td>
                                            <select class="form-control to_bin_id intDetailFrom" name="to_bin_id"></select>
                                        </td>
    ...
    function checkItemBin(data = 0, locId = 0) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.activeUnit').val(data.item.unit_of_measures.abbreviation);
                $('.activePref').val(data.bin.bins.bin_no);
            },
            error: function () {
            }
        })
