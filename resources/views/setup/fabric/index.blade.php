...
@section('breadcrumb')
    ...
    <div class="col-md-6 col-sm-12 text-right hidden-xs">
        <a href="{{ route('setup.fabric.new') }}" class="btn btn-sm btn-primary" title="">New Fabric</a>
    </div>
@endsection
                                ...
                                <tbody>
                                    @if (!empty($fabrics))
                                        @foreach ($fabrics as $fabric)
                                            <tr>
                                                <th><a href="{{ route('setup.fabric.edit', $fabric->fabric_id) }}" title="">Edit</a> | <a href="{{ route('setup.fabric.view', $fabric->fabric_id) }}" title="">View</a></th>
                                                <td>{{ $fabric->fabric_id }}</td>
                                                <td>{{ $fabric->name }}</td>
                                                <td>{{ $fabric->abbreviation }}</td>
                                                <td>{{ $fabric->idx }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
