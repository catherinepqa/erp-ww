...
@section('breadcrumb')
    ...
    <div class="col-md-6 col-sm-12 text-right hidden-xs">
        <a href="{{ route('setup.product_categories.new') }}" class="btn btn-sm btn-primary" title="">New Product Category</a>
    </div>
@endsection
                                ...
                                <tbody>
                                    @if (!empty($productCategories))
                                        @foreach ($productCategories as $productCategory)
                                            <tr>
                                                <th><a href="{{ route('setup.product_categories.edit', $productCategory->product_category_id) }}" title="">Edit</a> | <a href="{{ route('setup.product_categories.view', $productCategory->product_category_id) }}" title="">View</a></th>
                                                <td>{{ $productCategory->product_category_id }}</td>
                                                <td>{{ $productCategory->name }}</td>
                                                <td>{{ $productCategory->idx }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </tbody>
