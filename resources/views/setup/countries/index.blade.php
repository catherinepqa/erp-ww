...
@section('breadcrumb')
    ...
    <div class="col-md-6 col-sm-12 text-right hidden-xs">
        <a href="{{ route('setup.countries.new') }}" class="btn btn-sm btn-primary" title="">New Country</a>
    </div>
@endsection
                                ...
                                <tbody>
                                    @if (!empty($countries))
                                        @foreach ($countries as $country)
                                            <tr>
                                                <th><a href="{{ route('setup.countries.edit', $country->country_id) }}" title="">Edit</a> | <a href="{{ route('setup.countries.view', $country->country_id) }}" title="">View</a></th>
