...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ action('SetupController@store_country') }}" data-parsley-validate  method="post">
                {{ csrf_field() }}
                <div class="card">
                    <div class="actionBtn">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="area_code" data-parsley-maxlength="10">
                                </div>
                            </div>
                        </div>
                        <div class="row">
