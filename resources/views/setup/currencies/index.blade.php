...
@section('breadcrumb')
    ...
    <div class="col-md-6 col-sm-12 text-right hidden-xs">
        <a href="{{ route('setup.currencies.new') }}" class="btn btn-sm btn-primary" title="">New Currencies</a>
    </div>
@endsection
                                ...
                                <tbody>
                                    @if (!empty($currencies))
                                        @foreach ($currencies as $currency)
                                            <tr>
                                                <th><a href="{{ route('setup.currencies.edit', $currency->currency_id) }}" title="">Edit</a> | <a href="{{ route('setup.currencies.view', $currency->currency_id) }}" title="">View</a></th>
                                                <td>{{ $currency->currency_id }}</td>
                                                <td>{{ $currency->name }}</td>
                                                <td>{{ $currency->countries->name }}</td>
