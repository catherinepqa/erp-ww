...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ action('SetupController@store_currency') }}" data-parsley-validate  method="post">
                {{ csrf_field() }}
                <div class="card">
                    <div class="actionBtn">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="iso_code" required data-parsley-maxlength="10">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Symbol</label>
                                    <input type="text" class="form-control" name="symbol" data-parsley-maxlength="10">
                                </div>
                            </div>
                        </div>
                        <div class="row">
