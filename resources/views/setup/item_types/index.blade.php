...
@section('breadcrumb')
    ...
    <div class="col-md-6 col-sm-12 text-right hidden-xs">
        <a href="{{ route('setup.item_types.new') }}" class="btn btn-sm btn-primary" title="">New Item Type</a>
    </div>
@endsection
                                ...
                                <tbody>
                                    @if (!empty($itemTypes))
                                        @foreach ($itemTypes as $itemType)
                                            <tr>
                                                <th><a href="{{ route('setup.item_types.edit', $itemType->item_type_id) }}" title="">Edit</a> | <a href="{{ route('setup.item_types.view', $itemType->item_type_id) }}" title="">View</a></th>
