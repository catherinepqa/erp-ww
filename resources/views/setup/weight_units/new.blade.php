...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ action('SetupController@store_weightUnit') }}"  data-parsley-validate enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
                <div class="card">
                    <div class="actionBtn">
                    ...
                    <div class="body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="subweight_unit_id">
                                        ...
                                        @foreach ($weightUnits as $weightUnit)
                                            <option value="{{ $weightUnit->weight_unit_id }}">{{ $weightUnit->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label>Idx</label>
                                    <input type="text" class="form-control" name="idx" required data-parsley-trigger="keyup" data-parsley-type="digits"  data-parsley-trigger="keyup" data-parsley-type="digits">
                                    @if ($errors->has('idx'))
