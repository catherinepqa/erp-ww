...
@section('breadcrumb')
    ...
    <div class="col-md-6 col-sm-12 text-right hidden-xs">
        <a href="{{ route('setup.tax_types.new') }}" class="btn btn-sm btn-primary" title="">New Tax Type</a>
    </div>
@endsection
                                ...
                                <tbody>
                                    @if (!empty($taxTypes))
                                        @foreach ($taxTypes as $taxType)
                                            <tr>
                                                <th><a href="{{ route('setup.tax_types.edit', $taxType->tax_type_id) }}" title="">Edit</a> | <a href="{{ route('setup.tax_types.view', $taxType->tax_type_id) }}" title="">View</a></th>
                                                <td>{{ $taxType->tax_type_id }}</td>
                                                <td>{{ $taxType->name }}</td>
