    ...
    <div class="col-md-6 col-sm-12">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Item Options</li>
            </ol>
        </nav>
    </div>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ action('SetupController@store_itemOption') }}" data-parsley-validate  method="post">
                {{ csrf_field() }}
                <div class="card">
                    <div class="actionBtn">
