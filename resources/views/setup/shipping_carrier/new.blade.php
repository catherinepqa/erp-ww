...
@section('breadcrumb')
    <div class="col-md-6 col-sm-12">
        <h1>Shipping Carrier</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Home</li>
                <li class="breadcrumb-item">Setup</li>
                <li class="breadcrumb-item active" aria-current="page">Shipping Carrier</li>
            </ol>
        </nav>
    </div>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ action('SetupController@store_shippingCarrier') }}"  method="post">
                {{ csrf_field() }}
                <div class="card">
                    <div class="actionBtn">
                        <button class="btn btn-success" type="submit">Save</button>
                        <a href="{{ route('setup.shipping_carrier.index') }}" class="btn btn-danger" title="">Cancel</a>
