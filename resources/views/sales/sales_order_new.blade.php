                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="sales-order-no" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="customer-name" class="form-control" required>
                                                ...
                                                @foreach ($customers as $row)
                                                    <option value="{{ $row->customer_id }}">{{ $row->lname }}, {{ $row->fname }} {{ $row->mname }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="customer-email" type="text" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">    
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="sales-order-date" data-date-autoclose="true" class="form-control" data-date-format="mm/dd/yyyy" required data-parsley-required data-parsley-trigger-after-failure="change" data-parsley-errors-container="#error-sales-order-date">
                                        </div>
                                    ...
                                    <div class="col-lg-6">    
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="sales-effective-date" data-date-autoclose="true" class="form-control" data-date-format="mm/dd/yyyy" required data-parsley-required data-parsley-trigger-after-failure="change" data-parsley-errors-container="#error-sales-effective-date">
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>PO No.</label>
                                            <input id="po-no" type="text" class="form-control">
                                        </div>
                                    </div>
                         ...
                         <div class="row">
                             <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="customer-memo" class="form-control" rows="4"></textarea> 
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="internal-memo" class="form-control" rows="4"></textarea> 
                                </div>
                            </div>
                         </div>
                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="discount-item" class="form-control">
                                                ...
                                                @foreach ($discount_type as $row)
                                                    <option value="{{ $row->discount_type_id }}~{{ $row->rate }}">{{ $row->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input id="discount-rate" type="text" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">    
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input id="shipping-date" data-date-autoclose="true" class="form-control" data-date-format="mm/dd/yyyy">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="shipping-carrier" class="form-control">
                                                        ...
                                                        @foreach ($shipping_carrier as $row)
                                                            <option value="{{ $row->shipping_carrier_id }}">{{ $row->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="shipping-tax-code" class="form-control">
                                                        ...
                                                        @foreach ($tax_codes as $row)
                                                            <option value="{{ $row->tax_code_id }}~{{ $row->tax_rate }}">{{ $row->tax_type }} : {{ $row->tax_code }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Shipping Tax Rate</label> 
                                                     <input id="shipping-tax-rate" type="text" class="form-control" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-8">    
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Ship To</label>
                                                    <input id="ship-to" type="text" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <textarea id="shipping-address" class="form-control" rows="4"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-8">    
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Bill To</label>
                                                    <input id="bill-to" type="text" class="form-control">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="currency" class="form-control">
                                                        ...
                                                        @foreach ($currencies as $row)
                                                            <option value="{{ $row->currency_id }}~{{ $row->rate }}">{{ $row->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="exchange-rate" type="text" class="form-control" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('js/pages/sales/sales_order_new.js') }}"></script>
@endsection
