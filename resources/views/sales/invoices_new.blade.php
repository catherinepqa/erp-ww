...
@section('content')
    <form id="form">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="invoice-no" type="text" class="form-control" required> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">    
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="invoice-date" data-date-autoclose="true" class="form-control" data-date-format="mm/dd/yyyy" required data-parsley-required data-parsley-trigger-after-failure="change" data-parsley-errors-container="#error-invoice-date">
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select id="posting-period" class="form-control" required>
                                                <option value="">Select...</option>
                                    
                                                @for ($i = 1; $i <= 8; $i++)
                                                    <option>{{ date("Y-M", strtotime(date( '2019-11' )." +$i months")) }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Representative</label>
                                     <select id="representative" class="form-control">
                                        <option value="">Select...</option>

                                        @foreach ($representatives as $row)
                                            <option value="{{ $row->representative_id }}">{{ $row->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">    
                             ...
                             <div class="col-lg-4">
                                <div class="alert alert-warning" style="margin-bottom: 0;">
                                    <h5>Created From :</h5>
                                    <p style="margin-top: 15px; margin-bottom: 0;">Sales Order No. <b><a href="{{ url('sales/sales_order/view/'. $id) }}" style="color: #856404;">{{ $sales_order->reference_no }}</a></b></p>
                                </div>
                            </div>
                         </div>
                    </div>
                         ...
                         <div class="row">
                             <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="order-memo" class="form-control" rows="4">{{ $sales_order->internal_memo }}</textarea> 
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-4">    
                                        ...
                                        <div class="row">
                                           <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Balance</label>
                                                    <input id="balance" type="text" class="form-control" onkeypress="return IsDouble(event);">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <input id="reference-id" type="hidden" value="{{ $id }}">  
    </form>
...
@section('script')
    ...
    <script src="{{ URL::asset('js/pages/sales/invoices_new.js') }}"></script>
@endsection
