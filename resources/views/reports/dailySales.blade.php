                ...
                <div class="row" style="margin-top: 3%;">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable dailySales">
                                <thead>
                                    <tr>
                                        <th>ACCOUNT</th>
                                        <th>TYPE</th>
                    ...
                    <div class="hidden_values" style="display: none">
                        @include('report_partials._printDailySales');
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function filter()
    {
        ...
        $.ajax({
            url: "{{ action('ReportsController@filterDailySales') }}",
            method: 'GET',
            dataType: "json",
    ...
    function exportReport(btn)
    {
        ...
        $.ajax({
            url: "{{ action('ReportsController@exportDailySales') }}",
            method: 'GET',
            xhrFields: {
                responseType: 'blob'
            },
